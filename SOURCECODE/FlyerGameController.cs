...
- GameController [modified class]

Added audio objects which need to play at game start.
...
namespace VRStandardAssets.Flyer
{
    ...
    public class FlyerGameController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_PlaybackDelayTime = 5f;                          // The delay time of the game music playback.
        ...
        [SerializeField] private FlyerLaserController m_FlyerLaserController;
        ...
        [SerializeField] private GameObject m_flyerPlayership;

        [SerializeField] private GameObject[] m_AudioEventArray;
        [SerializeField] private AudioSource m_SwimAudioEvent;

        [SerializeField] private FlowEffectScript m_CameraRender;
