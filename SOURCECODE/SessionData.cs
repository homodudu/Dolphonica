...
namespace VRStandardAssets.Common
{
    ...
    public static class SessionData
    {
        ...
        private static int s_Combo;                                 // Used to store the current game's score.
        ...
        public static int Combo { get { return s_Combo; } }
        ...
        public static void AddCombo(int combo)
        {
            // Add to the current score and check if the high score needs to be set.
            s_Combo += combo;
        }
